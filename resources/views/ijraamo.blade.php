    ...
    <div class="form_wrapper">
        <div class="form_container">
          <div class="title_container">
            <h1>اضافة إجراء مباشر:</h1>
          </div>
          <br/>
          <br/>
          <div class="row clearfix">
            <div class="">
            <form  class="file_form" method="POST" action="{{ route('modiijraa', $table->Raqem) }}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="input_field full-field">
                    ...
                    <input type="text" name="ijraa_type" value="{{  $table->ijraa_type }}" placeholder="نوع الاجراء " required />
                </div>
                <div class="input_field full-field">
                    <label class="field-text">تاريخ تسلم الاجراء
                    </label>
                    <input type="date" name="date_receive" value="{{  $table->date_receive }}" required placeholder=" تاريخ تسلم الوثيقة مموضوع الاجراء" />
                </div>
                <div class="input_field full-field">
               ...
               <div class="input_field full-field">
                ...
                <input type="text" name="matlob" value="{{  $table->matlob }}" placeholder=" المطلوب ضده " required/>
              </div>
              <div class="input_field full-field">
                <label class="field-text">تاريخ انجاز الاجراء               </label>
                <input type="date" name="date_creation" value="{{  $table->creat_date }}" placeholder="" />
              </div>
              <div class="input_field full-field">
                <label class="field-text">ملخص الاجراءات المنجزة                </label>
                <input type="text" name="resume" value="{{  $table->ijraa_rs }}" placeholder=" ملخص الاجراءات المنجزة  "/>
            </div>
              <div class="input_field full-field">
                <label class="field-text">تاريخ تسليم الوثيقة
                </label>
                <input type="date" name="watika_r" value="{{  $table->watika_reciev }}" placeholder="" />
            </div>
              <div class="input_field full-field">
