            ...
            <div class="">
              <form  class="file_form" method="POST" action="{{ route('create_tabligh') }}">
                ...
                <div class="input_field full-field">
                    ...
                    <div id="input_holder">
                     <input type="number" min="1" placeholder="الرقم"name="rakem_kad" >
                     /
                     <input type="text" name="ramez_kad" placeholder="الزمز">
                     /
                     <input type="number" min="2022" name="year_kad" placeholder="السنة">
                     <span>*</span>
                    </div>
                </div>
                <div class="input_field full-field select_option">
              ...
              <div class="input_field full-field select_option">
                ...
                <div class="select_arrow" ></div>
                    <select id="it_source" name="it_source">
                      <option>... اختيار</option>
                      <option value="1">محاكم الإستئناف</option>
                      <option value="2">المحاكم الإبتدائية</option>
                      <option value="3">المحاكم التجارية</option>
                      <option value="4">محاكم الإستئناف التجارية</option>
                      <option value="5">المحاكم الإدارية</option>
              ...
              <div class="input_field full-field select_option">
                ...
                <div class="select_arrow" ></div>
                    <select name="it_source">
                    <option value="0">------------</option>
                    <option value="1">محكمة الاستئناف بالرباط</option>
                    <option value="12">محكمة الاستئناف الدار البيضاء</option>
                    <option value="18">محكمة الاستئناف بأكادير</option>
                    <option value="48">محكمة الاستئناف بورزازات</option>
                    <option value="62">محكمة الاستئناف بالحسيمة</option>
                    <option value="69">محكمة الاستئناف بتازة</option>
                    <option value="86">محكمة الاستئناف ببني ملال</option>
                    <option value="110">محكمة الاستئناف بفاس</option>
                    <option value="130">محكمة الاستئناف بالقنيطرة</option>
                    <option value="144">محكمة الاستئناف بالعيون</option>
                    <option value="149">محكمة الاستئناف بمراكش</option>
                    <option value="160">محكمة الاستئناف بمكناس</option>
                    <option value="177">محكمة الاستئناف بالرشيدية</option>
                    <option value="197">محكمة الاستئناف بوجدة</option>
                    <option value="216">محكمة الاستئناف بالناضور</option><option value="222">محكمة الاستئناف بآسفي</option><option value="232">محكمة الاستئناف بالجديدة</option><option value="241">محكمة الاستئناف بسطات</option><option value="249">محكمة الاستئناف بخريبكة</option><option value="253">محكمة الاستئناف بطنجة</option><option value="258">محكمة الاستئناف بتطوان</option><option value="377">محكمة الاستئناف بكلميم</option>
                    </select>
              </div>
              <div class="mahkama input_field full-field select_option"></div>
               <div class="input_field full-field">
              ...
              <div class="input_field full-field  ">
                ...
                <input type="text" name="naib" placeholder=" اسم المطلوب ضده الاجراء و من ينوب عنه " />
              </div>
              <div class="input_field full-field">
                <label class="field-text">تاريخ انجاز الاجراء                </label>
                <input type="date" name="date_ijraa" placeholder="" required />
            </div>
              <div class="input_field full-field">
              ...
              <div class="input_field full-field">
                ...
                <input type="file" id="myfile" name="watika" placeholder="" required />
              </div>
              <div class="input_field full-field">
